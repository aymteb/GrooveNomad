      ...
      <div className="carousel-content">
        <div className="carousel-track" style={{ transform: `translateX(-${currentSlide * 100}%)` }}>
          {festivals.map((festival, index) => (
            <div key={festival.id} className={`carousel-slide ${festival.className}`}>
