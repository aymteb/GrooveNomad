...
const festivals = [
  ...
  },
  {
    ...
    image:
      'https://cdn.prod.website-files.com/61ca202c21faec1a3d1b4937/65f27783ca1eef0adf597c18_bvx%20cfv.png',
  },
  {
    id: 3,
    name: 'Rhythm Valley',
    ...
    image:
      'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQj3Pg2G7LLVPkzPBTwf-As-Nn8gMDFfM2ZNQ&s',
  },
];
        ...
        {festivals.map((_, idx) => (
          <button
            ...
            style={{
              ...
              outline: 'none',
              boxShadow:
                idx === current ? '0 2px 8px rgba(0,0,0,0.10)' : 'none',
            }}
